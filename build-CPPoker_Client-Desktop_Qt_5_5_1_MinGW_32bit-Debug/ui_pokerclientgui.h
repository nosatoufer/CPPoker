...
public:
    ...
    void setupUi(QMainWindow *PokerClientGui)
    {
        ...
        actionD_marrer = new QAction(PokerClientGui);
        actionD_marrer->setObjectName(QStringLiteral("actionD_marrer"));
        ...
        menuPartie->addAction(actionD_marrer);
    ...
    void retranslateUi(QMainWindow *PokerClientGui)
    {
        ...
        actionD_marrer->setText(QApplication::translate("PokerClientGui", "D\303\251marrer", 0));
